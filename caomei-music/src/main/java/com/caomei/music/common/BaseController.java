package com.caomei.music.common;

import com.caomei.music.entity.QueryPage;
...
public class BaseController {
    ...
    protected void init(Model model){model.addAttribute("user",(User)SecurityUtils.getSubject().getPrincipal());}
